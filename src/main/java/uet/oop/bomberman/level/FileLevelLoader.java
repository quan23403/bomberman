...
public class FileLevelLoader extends LevelLoader {
    ...
    /**
     * Đọc bản đồ từ tệp cấu hình.
     * đường dẫn tới tệp cấu hình.
     *
     * @throws LoadLevelException nếu không thể đọc được tệp cấu hình.
     */
    ...
    public void loadLevel(int level) {
        ...
        try {
            FileReader fr = new FileReader("/level/Level" + level + ".txt");//doc tep luu map
